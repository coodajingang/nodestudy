...
function XL0_calc(xt, zn, t, n) {
  ...
  for (i = 0;
    ...
    if (n < 0) N = n2;
      ...
      j < N;
      j += 3)c += F[j] * Math.cos(F[j + 1] + t * F[j + 2]);
    v += c * tn;
  } v /= F[0];
  if (xt == 0) {
    var t2 = t * t, t3 = t2 * t;
...
function pluto_coord(t) {
  ...
  for (i = 0;
    ...
    for (j = 0;
      j < N;
      j += 3)v += ob[j] * Math.sin(ob[j + 1] * T + ob[j + 2] * c0);
    if (i % 3 == 1) v *= x;
    if (i % 3 == 2) v *= x * x;
...
function XL1_calc(zn, t, n) {
  ...
  for (i = 0;
    ...
    for (j = 0, c = 0;
      j < N;
      j += 6)c += F[j] * Math.cos(F[j + 1] + t * F[j + 2] + t2 * F[j + 3] + t3 * F[j + 4] + t4 * F[j + 5]);
    v += c * tn;
  } if (zn != 2) v /= rad;
  return v;
};
...
function hxCalc(t, F, Q, lx, L, fa) {
  ...
  L: 0, fa: 0, dt: 0, E: 0.409092614, getH:
    function (h, w) {
...
function xingLiu(xt, t, sn) {
  ...
  for (i = 0;
    i < 6;
    i++)t -= rad2rrad(XL0_calc(xt, 0, t, 8) - XL0_calc(0, 0, t, 8)) / v;
...
function xingHR(xt, t, f) {
  ...
  for (i = 0;
    i < 6;
    i++)t -= rad2rrad(XL0_calc(xt, 0, t, 8) - XL0_calc(0, 0, t, 8) - w0) / v;
...
function ecFast(jd) {
  ...
  Zs: new Array(), Zdt: 0.04, Zjd: 0, dT: 0, tanf1: 0.0046, tanf2: 0.0045, srad: 0.0046, bba: 1, bhc: 0, dyj: 23500, init:
    function (jd, n) {
    ...
    function (jd, xt) {
      ...
      for (i = 0;
        i < m;
        i++, p++)z[i] = B[p] + (B[p + w] - B[p - w] + (B[p + w] + B[p - w] - B[p] * 2) * t) * t / 2;
      return z;
    }, sun:
    function (jd) {
...
var rsPL = {
  nasa_r: 0, sT: new Array(), secXY:
    function (jd, L, fa, high, re) {
      var deltat = dt_T(jd);
      var zd = nutation2(jd / 36525);
    ...
    }, A: new Array(), B: new Array(), P: { S: new Array(), M: new Array(), g: 0 }, Q: { S: new Array(), M: new Array(), g: 0 }, V: new Array(), Vc: '', Vb: '', zb0:
    function (jd) {
      var deltat = dt_T(jd);
      var E = hcjj(jd / 36525);
      var zd = nutation2(jd / 36525);
...
var obb = {
  JNB: '', numCn: new Array('零', '一', '二', '三', '四', '五', '六', '七', '八', '九', '十'), Gan: new Array("甲", "乙", "丙", "丁", "戊", "己", "庚", "辛", "壬", "癸"), Zhi: new Array("子", "丑", "寅", "卯", "辰", "巳", "午", "未", "申", "酉", "戌", "亥"), ShX: new Array("鼠", "牛", "虎", "兔", "龙", "蛇", "马", "羊", "猴", "鸡", "狗", "猪"), XiZ: new Array('摩羯', '水瓶', '双鱼', '白羊', '金牛', '双子', '巨蟹', '狮子', '处女', '天秤', '天蝎', '射手'), yxmc: new Array("朔", "上弦", "望", "下弦"), jqmc: new Array('冬至', '小寒', '大寒', '立春', '雨水', '惊蛰', '春分', '清明', '谷雨', '立夏', '小满', '芒种', '夏至', '小暑', '大暑', '立秋', '处暑', '白露', '秋分', '寒露', '霜降', '立冬', '小雪', '大雪'), ymc: new Array('冬', '腊', '正', '二', '三', '四', '五', '六', '七', '八', '九', '十'), rmc: new Array('初一', '初二', '初三', '初四', '初五', '初六', '初七', '初八', '初九', '初十', '十一', '十二', '十三', '十四', '十五', '十六', '十七', '十八', '十九', '二十', '廿一', '廿二', '廿三', '廿四', '廿五', '廿六', '廿七', '廿八', '廿九', '三十', '卅一'), gzny: new Array("大海水", "海中金", "炉中火", "大林木", "路旁土", "剑锋金", "山头火", "洞下水", "城墙土", "白腊金", "杨柳木", "泉中水", "屋上土", "霹雷火", "松柏木", "常流水", "沙中金", "山下火", "平地木", "壁上土", "金箔金", "佛灯火", "天河水", "大驿土", "钗钏金", "桑松木", "大溪水", "沙中土", "天上火", "石榴木", "大海水"), scd: new Array('正', '初'), TimeK: new Array('初', '一', '二', '三', '四'), jqjl: new Array('中', '节'), init:
    ...
    function (u, r) {
      ...
      if (u.Lleap != '闰') {
        if (d == '正月初一') r.A += '春节 ', r.B += '鸡日 ', r.C += '元始天尊圣诞.弥勒佛圣诞<br>', r.Fjia = 1;
        if (d == '正月初二') r.B += '大年初二 ', r.C += '鸭日 ', r.Fjia = 1;
        if (d == '正月初三') r.C += '大年初三 猫日 孙真人圣诞、郝真人圣诞 ', r.Fjia = 1;
        if (d == '正月初四') r.C += '狗日 ';
        if (d == '正月初五') r.C += '破五 猪日 路神生日';
        if (d == '正月初六') r.C += '羊日 定光佛圣诞 ';
        if (d == '正月初七') r.C += '人日 ';
        if (d == '正月初八') r.C += '马日 阎王诞 ';
        if (d == '正月初九') r.C += '牛日 玉皇大帝圣诞 ';
        if (d == '正月初十') r.C += '骆驼日 ';
        if (d == '正月十三') r.C += '上灯节 ';
        if (d == '正月十四') r.C += '灯花节 ';
        if (d == '正月十五') r.A += '元宵节 ', r.B += '上元节 ', r.C += '壮族歌墟节 苗族踩山节 达斡尔族卡钦 上元天官圣、门神户尉圣诞、混元帝君圣诞 ';
        ...
        if (d == '正月廿七') r.C += '老人日 ';
        if (d == '正月廿九') r.C += '送穷日 ';
        if (d == '二月初一') r.C += '瑶族忌鸟节 勾陈圣诞、剑真人圣诞 ';
        if (d == '二月初二') r.B += '春龙节(龙抬头) ', r.C += '畲族会亲节 土地正神圣诞 济公诞';
        if (d == '二月初三') r.C += '文昌梓童帝君圣诞 ';
        if (d == '二月初六') r.C += '东华帝君圣诞 ';
        if (d == '二月初八') r.C += '傈傈族刀杆节 释迦牟尼佛出家 昌福真君圣诞 ';
        if (d == '二月初九') r.C += '海空上师生日 ';
        if (d == '二月十二') r.C += '花神诞 ';
        if (d == '二月十三') r.C += '葛真君圣诞 ';
        if (d == '二月十五') r.C += '傈傈族刀杆节 释迦牟尼佛涅槃 九天玄女诞、太上老君圣诞、精忠岳元帅圣诞 ';
        if (d == '二月十九') r.C += '观世音菩萨圣诞 ';
        if (d == '二月廿一') r.C += '普贤菩萨圣诞、水母圣诞 ';
        if (d == '二月廿五') r.C += '玄天圣父真帝圣诞 ';
        if (d == '三月初三') r.B += '北帝诞 ', r.C += '苗族黎族歌墟节 王母诞.北极真武玄天大帝圣诞 ';
        if (d == '三月初六') r.C += '眼光娘娘圣诞、张果老圣诞 ';
        if (d == '三月十五') r.C += '白族三月街(至三月二十) 昊天大帝圣诞、玄坛赵公明元帅圣诞、泰山老母诞 ';
        if (d == '三月十六') r.C += '准提菩萨圣诞、山神圣诞 ';
        if (d == '三月十八') r.C += '后土娘娘圣诞、中岳大帝圣诞 ';
        if (d == '三月二十') r.C += '子孙娘娘圣诞 ';
        if (d == '三月廿三') r.B += '天后诞 妈祖诞 ';
        if (d == '三月廿八') r.C += '东岳大帝圣诞、苍颉至圣先师圣诞 ';
        if (d == '四月初四') r.C += '文殊菩萨圣诞 ';
        if (d == '四月初八') r.B += '牛王诞 ', r.C += '释迦牟尼佛圣诞 ';
        if (d == '四月十二') r.C += '蛇王诞 ';
        if (d == '四月十四') r.C += '吕纯阳(吕洞宾)祖师圣诞 ';
        if (d == '四月十五') r.C += '佛吉祥日——释迦牟尼佛诞生、成道、涅槃三期同一庆(即南传佛教国家的卫塞节)、钟离祖师圣诞 ';
        if (d == '四月十八') r.C += '锡伯族西迁节 紫徽大帝圣诞 华佗神医诞 ';
        if (d == '四月廿八') r.C += '药王神农圣诞 ';
        if (d == '五月初一') r.C += '南极长生大帝圣诞 ';
        if (d == '五月初五') r.A += '端午节 ', r.C += '地坻温元帅圣诞、雷霆邓天君圣诞 ', r.Fjia = 1;
        if (d == '五月十一') r.C += '都城隍圣诞 ';
        if (d == '五月十三') r.B += '关帝诞、皇帝诞 ', r.C += '阿昌族泼水节.伽蓝菩萨圣诞 ';
        if (d == '五月十八') r.C += '张天师圣诞 ';
        if (d == '五月廿二') r.C += '鄂温克族米阔鲁节 ';
        if (d == '五月廿九') r.C += '瑶族达努节 ';
        if (d == '六月初三') r.C += '护法韦驮尊天菩萨圣诞 ';
        if (d == '六月初六') r.B += '姑姑节 天贶节 ', r.C += '壮族祭田节 瑶族尝新节 ';
        if (d == '六月十一') r.C += '王灵官圣诞、马神圣诞 ';
        if (d == '六月十九') r.C += '观世音菩萨成道——此日放生、念佛，功德殊胜 ';
        if (d == '六月廿四') r.B += '火把节、星回节(彝、白、佤、阿昌、纳西、基诺族 ) ', r.C += '雷神圣诞、关公诞、荷花仙子诞 ';
        if (d == '六月廿六') r.C += '二郞真君圣诞 ';
        if (d == '七月初七') r.B += '七夕(中国情人节,乞巧节,女儿节 ) ';
        if (d == '七月十三') r.C += '侗族吃新节.大势至菩萨圣诞 ';
        if (d == '七月十五') r.B += '中元节 鬼节 ', r.C += '中元地官圣诞 ';
        if (d == '七月十八') r.C += '西王母娘娘圣诞 ';
        if (d == '七月十九') r.C += '值年太岁圣诞 ';
        if (d == '七月二十') r.C += '棉花诞 ';
        if (d == '七月廿三') r.C += '诸葛武侯诞 ';
        if (d == '七月廿四') r.C += '龙树王菩萨圣诞 ';
        if (d == '七月三十') r.C += '地藏菩萨圣诞 ';
        if (d == '八月初三') r.C += '灶王神圣诞 ';
        if (d == '八月初十') r.C += '北岳大帝圣诞 ';
        if (d == '八月十五') r.A += '中秋节 ', r.Fjia = 1;
        if (d == '八月廿二') r.C += '燃灯佛圣诞 ';
        if (d == '九月初三') r.C += '五瘟圣诞 ';
        if (d == '九月初九') r.B += '重阳节 ', r.C += '老人节(2013) 斗母元君圣诞、都天大帝圣诞、梅葛二仙翁圣诞 ';
        if (d == '九月十七') r.C += '金龙四大天王圣诞 ';
        if (d == '九月十九') r.C += '观世音菩萨出家纪念日 ';
        if (d == '九月廿二') r.C += '增福财神圣诞 ';
        if (d == '九月三十') r.C += '药师琉璃光如来圣诞 ';
        if (d == '十月初一') r.B += '祭祖节(十月朝) ', r.C += '东皇大帝圣诞 ';
        if (d == '十月初五') r.C += '达摩祖师圣诞 ';
        if (d == '十月十五') r.B += '下元节 ', r.C += '下元水天官圣诞 ';
        if (d == '十月十六') r.C += '瑶族盘王节 ';
        if (d == '冬月初四') r.C += '大成至圣先师文宣王孔子圣诞 ';
        if (d == '冬月初六') r.C += '西岳大帝圣诞 ';
        if (d == '冬月初七') r.C += '阿弥陀佛圣诞 ';
        if (d == '冬月十一') r.C += '太乙救苦天尊圣诞 ';
        if (d == '冬月十七') r.C += '阿弥陀佛圣诞 ';
        if (d == '冬月十九') r.C += '日光天子圣诞、大慈至圣九还菩萨圣诞 ';
        if (d == '腊月初八') r.B += '腊八节 ', r.C += '释迦如来成道日 ';
        if (d == '腊月十六') r.C += '南岳大帝圣诞 ';
        if (d == '腊月二十') r.C += '鲁班先师圣诞 ';
        if (d == '腊月廿一') r.B += '天庆大帝圣诞 ';
        if (d == '腊月廿三') r.B += '小年 ';
        if (d == '腊月廿九') r.C += '华严菩萨圣诞 ';
      } if (u.Lmc2 == '正') {
    ...
    function (jd, J, ob) {
      ...
      for (i = 0;
        ...
        if (SC == i) ob.bz_js = c, c = '<font color=red>' + c + '</font>', ob.ny = this.gzny[Math.round((((60 + (v + i + 1) % 60) % 60) / 2), 0)];
        ob.bz_JS += (i ? ' ' : '') + c;
      }
    }, qi_accurate:
    function (W) {
...
var SSQ = {
  SB: '', QB: '', suoKB: new Array(1457698.231017, 29.53067166, 1546082.512234, 29.53085106, 1640640.735300, 29.53060000, 1642472.151543, 29.53085439, 1683430.509300, 29.53086148, 1752148.041079, 29.53085097, 1807665.420323, 29.53059851, 1883618.114100, 29.53060000, 1907360.704700, 29.53060000, 1936596.224900, 29.53060000, 1939135.675300, 29.53060000, 1947168.00), qiKB: new Array(1640650.479938, 15.21842500, 1642476.703182, 15.21874996, 1683430.515601, 15.218750011, 1752157.640664, 15.218749978, 1807675.003759, 15.218620279, 1883627.765182, 15.218612292, 1907369.128100, 15.218449176, 1936603.140413, 15.218425000, 1939145.524180, 15.218466998, 1947180.798300, 15.218524844, 1964362.041824, 15.218533526, 1987372.340971, 15.218513908, 1999653.819126, 15.218530782, 2007445.469786, 15.218535181, 2021324.917146, 15.218526248, 2047257.232342, 15.218519654, 2070282.898213, 15.218425000, 2073204.872850, 15.218515221, 2080144.500926, 15.218530782, 2086703.688963, 15.218523776, 2110033.182763, 15.218425000, 2111190.300888, 15.218425000, 2113731.271005, 15.218515671, 2120670.840263, 15.218425000, 2123973.309063, 15.218425000, 2125068.997336, 15.218477932, 2136026.312633, 15.218472436, 2156099.495538, 15.218425000, 2159021.324663, 15.218425000, 2162308.575254, 15.218461742, 2178485.706538, 15.218425000, 2178759.662849, 15.218445786, 2185334.020800, 15.218425000, 2187525.481425, 15.218425000, 2188621.191481, 15.218437494, 2322147.76), so_low:
    ...
    function (jd, qs) {
      ...
      if (jd < f1 || jd >= f3) {
        if (qs == '气') return Math.floor(this.qi_high(Math.floor((jd + pc - 2451259) / 365.2422 * 24) * Math.PI / 12) + 0.5);
        else return Math.floor(this.so_high(Math.floor((jd + pc - 2451551) / 29.5306) * Math.PI * 2) + 0.5);
      } if (jd >= f1 && jd < f2) {
        for (i = 0;
          i < B.length;
          i += 2)if (jd + pc < B[i + 2]) break;
    ...
    }, leap: 0, ym: new Array(), ZQ: new Array(), HS: new Array(), dx: new Array(), Yn: new Array(), calcY:
    function (jd) {
      ...
      if (YY >= -721 && YY <= -104) {
        ...
        if (Dm >= 1724360 && Dm <= 1729794) mc = obb.ymc[(v2 + 1) % 12];
        else if (Dm >= 1807724 && Dm <= 1808699) mc = obb.ymc[(v2 + 1) % 12];
        else if (Dm >= 1999349 && Dm <= 1999467) mc = obb.ymc[(v2 + 2) % 12];
...
function Dtlpq(pjqn) {
  ...
  var s = '';
  if (y < 1582 || y > 1644 || (y == 1644 && Cal_m.value - 0 == 12)) return s;
  var yearshi = 365.2425;
  var qiying = 55.0600;
  var qice = yearshi / 24;
...
function Lunar() {
  ...
  this.yueLiHTML =
    function (By, Bm, curJD) {
      ...
      var ta0 = '<tr><td colspan=7 style="background-color:#00AFFF" style="color=#FFFF00">' + c + '</td></tr>';
...
function GJ2_pi() {
  ...
  for (;
    ...
    i > 0;
    i--)a[i - 1] += Math.floor(a[i] / 10), a[i] %= 10;
  a[0] = '<br>';
  for (i = 1;
    i < N;
    i++) {
  ...
  add:
    ...
    function (a, v, n) {
      ...
      a[0] = v;
      a.length = n;
    }, a: new Array(), b: new Array(), c: new Array(), arctg:
    function (k, v, zf, N) {
